/************************* tajima.c *****************************************\
 This program calculates Tajima's D when number of sequences, number of 
   segregating sites, and average pairwise differences (pi) are known.  It 
   also reports all the coefficients for Tajima's D (a1, a2, b1, b2, c1, c2, 
   e1, e2). 
\****************************************************************************/
...
double tajd(int nsam, int segsites, double sumk)
{
  ...
  D = (sumk-(segsites/a1))/sqrt((e1*segsites)+((e2*segsites)*(segsites-1)));
